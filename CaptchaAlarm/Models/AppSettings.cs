...
namespace CaptchaAlarm.Models
{
    ...
    public class AppSettings
    {
        ...
        /// <summary>Whether to auto-solve CAPTCHA via OpenAI GPT-4o when the alarm fires.</summary>
        [JsonProperty("EnableAutoSolve")]
        public bool Enable2Captcha { get; set; } = false;

        /// <summary>OpenAI API key for GPT-4o Vision solving.</summary>
